...
const UserProfile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${process.env.NEXT_PUBLIC_API_URL}/api/statistics/user/${userId}`)
      .then((res) => {
  ...
  const problems =
    statistics?.rankDistribution?.map((r: any) => r.problemId) || [];
              ...
              <div className="mb-12">
                ...
                <div className="overflow-x-auto">
                  ...
                  <div className="flex gap-[2px] mt-6">
                    <div
                      className={`w-[10px] h-[10px] rounded-[2px] ${getColorClass(1)}`}
                    />
                    <div
                      className={`w-[10px] h-[10px] rounded-[2px] ${getColorClass(2)}`}
                    />
                    <div
                      className={`w-[10px] h-[10px] rounded-[2px] ${getColorClass(3)}`}
                    />
                    <div
                      className={`w-[10px] h-[10px] rounded-[2px] ${getColorClass(4)}`}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="ml-auto text-gray-900 text-base">
                      {statistics?.problemsAttempted || 0}
                    </span>
                  </div>
